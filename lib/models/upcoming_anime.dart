...
UpcomingAnime upcomingAnimeFromJson(String str) => UpcomingAnime.fromJson(json.decode(str));

String upcomingAnimeToJson(UpcomingAnime data) => json.encode(data.toJson());
...
class UpcomingAnime {
    ...
    factory UpcomingAnime.fromJson(Map<String, dynamic> json) => UpcomingAnime(
